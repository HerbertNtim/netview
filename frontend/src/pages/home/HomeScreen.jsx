	...
	return (
		<>
			<div className='relative h-screen text-white'>
				...
				{imgLoading && (
					<div className='absolute top-0 left-0 w-full h-full bg-black/50 flex items-center justify-center shimmer -z-10' />
				)}

				<img
					src={ORIGINAL_IMG_BASE_URL + trendingContent?.backdrop_path || '/assets/extraction.jpg'}
					alt='Hero img'
			...
			<div className='flex flex-col gap-2 bg-black py-10'>
				{contentType !== "movie"
