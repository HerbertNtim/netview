	...
	return (
        ...
        <Logo />
			...
			<div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
					...
					<div className='flex-1 text-center md:text-left'>
						<h2 className='text-4xl md:text-5xl text-red-700 font-extrabold mb-4'>Enjoy on your TV</h2>
			...
			<div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
					{/* left side */}
					<div className='flex-1 text-center md:text-left'>
						<h2 className='text-4xl md:text-5xl text-red-700 font-extrabold mb-4'>Watch everywhere</h2>
						<p className='text-lg md:text-xl'>
        ...
        '
				>
					...
					{/* right */}
					<div className='flex-1 text-center md:text-left'>
						<h2 className='text-4xl md:text-5xl text-red-700 font-extrabold mb-4'>Create profiles for kids</h2>
						<p className='text-lg md:text-xl'>
